		...
		<div>
			...
			<form>
				<div class="space-y-4 mt-8">
					...
					<textarea
						placeholder="Escriba su mensaje... Pronto nos contactaremos"
						class="px-2 pt-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#333] outline-none"
					></textarea>
				</div>
				<button
					type="button"
					class="mt-8 flex items-center justify-center text-sm w-full rounded px-4 py-2.5 font-semibold bg-mainRed text-white hover:bg-black"
				>
					<svg
			...
			<ul
				class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2"
			>
